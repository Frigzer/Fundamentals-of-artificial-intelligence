...
class ASLClassifier(nn.Module):
    def __init__(self, num_classes=36):
        ...
        self.conv2 = nn.Conv2d(32, 64, kernel_size=3, padding=1) # Drugi etap - znajduje kształy np. palce, kontury dłoni
        self.pool = nn.MaxPool2d(2, 2) # Zmniejsza rozdzielczośc, rozmiar obrazu na pół

        self.conv3 = nn.Conv2d(64, 128, kernel_size=3, padding=1) # Trzeci etap - znajduje całe gesty np. litera A, B, C
